...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget textSection = Container(
      ...
      child: Align(
        ...
        child: Text(
          ...
          'Tempat yang berada di atas bukit dengan ketinggian sekitar 1.326 mdpl ini banyak dikunjungi wisatawan untuk menjajal kegiatan outdoor paralayang.'
          '\n\n'
          'Author : Lukas Valentino'
          '\n'
          'NIM     : 2141720032 ',
          softWrap: true,
    ...
    return MaterialApp(
      title: 'Flutter layout: Lukas Valentino dan 2141720032',
      home: Scaffold(
          appBar: AppBar(
